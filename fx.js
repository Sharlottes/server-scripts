...
runner=()=>{};
fxA=()=>runner=()=>Call.effect(Fx.sparkShoot,sharp.x+Mathf.range(4*8),sharp.y+Mathf.range(4*8),sharp.unit().rotation,fxcol());
fxB=()=>runner=()=>Call.effect(Fx.lancerLaserShoot,sharp.x,sharp.y,sharp.unit().rotation*Time.time/20,fxcol());
...
startfx=()=>Events.run(Trigger.update,()=>runner())